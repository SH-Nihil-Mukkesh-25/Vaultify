...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://vaultify-git-master-mukkeshnihil-gmailcoms-projects.vercel.app",
        "*"  # Allow all origins for IoT devices, or restrict to your ESP32's IP
    ],
...
def add_log(entry: LogEntry):
    ...
    # Update vector store if AI is available
...
def summarize_logs():
    ...
    if llm is None:
        # Demo mode - return a simple summary
        event_counts = {}
        for log in logs:
...
def ask_ai(question: str):
    ...
    if llm is None:
        # Enhanced demo mode - provide intelligent responses based on actual data
        ...
        # Provide intelligent responses based on question
        if "door" in question_lower and "unlock" in question_lower:
            ...
            # Generic response with actual data
...
if __name__ == "__main__":
    ...
    print("  - POST /api/logs - Add new log")
    print("  - GET  /api/summary - Get AI summary")
    print("  - GET  /api/ask?question=... - Ask AI")
    print("🌐 Open frontend.html in your browser to see the dashboard")
